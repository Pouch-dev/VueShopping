...
<!-- Mirrored from themepure.net/template/vue/vue/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 12:34:04 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            ...
                            <form action="/index/login" method="post" enctype="multipart/form-data">
                                ...
                                <a href="/index/register" class="btn theme-btn w-100">Register Now</a>
                            </form>
                        </div>
                    </div>
                </div>
