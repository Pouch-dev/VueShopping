    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="/indexAD/Order"> <i
										...
										<table class="table table-striped custab">
											...
											<c:forEach var="item" items="${list_product.content}">
												<tr>
								                      ...
								                      <td class="text-center">(+84) ${item.phone}</td>
								                      <td class="text-center">${item.email}</td>
								                      <td class="td-actions text-right">
								                        <a class="btn btn-info btn-simple" href="/indexAD/editOrder/${item.id}"><i class="material-icons">person</i></a>
								                        <a class="btn btn-danger btn-simple" href="/indexAD/deleteOrder/${item.id}"><i class="material-icons">close</i></a>
								                      </td>
							                    </tr>
											</c:forEach>
										</table>
											...
											<div class="dataTables_paginate paging_full_numbers"
												...
												<ul class="pagination">
													<li class="paginate_button first">
														<a href="/indexAD/Order?show=0">First</a></li>
													<li class="paginate_button previous"><a
														href="/indexAD/Order?show=${list_product.number-1}">Previous</a></li>
													<li class="paginate_button next">
														<a href="/indexAD/Order?show=${list_product.number+1}">Next</a></li>
													<li class="paginate_button last">
														<a href="/indexAD/Order?show=${list_product.totalPages-1}">Last</a>
													</li>
												</ul>
											</div>
										</div>
