    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="/indexAD/Account"> <i
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						...
						<form action="/indexAD/User" method="post" class="navbar-form navbar-right" role="search">
				...
				<div class="content">
					<div class="container-fluid">
										...
										<table class="table table-striped custab">
											...
											<c:forEach var="item" items="${list_product.content}">
												<tr>
								                      ...
								                      <td class="text-center">${item.admin?'Quản Trị Viên':'Người Dùng'}</td>
								                      <td class="text-center">${item.activated?'Đang Hoạt Động':'Ngừng Hoạt Động'}</td>
								                      <td class="td-actions text-right">
								                        <a class="btn btn-info btn-simple" href="/indexAD/editAccount/${item.username}"><i class="material-icons">person</i></a>
								                        <a class="btn btn-danger btn-simple" href="/indexAD/deleteAccount/${item.username}"><i class="material-icons">close</i></a>
								                      </td>
							                    </tr>
											</c:forEach>
										</table>
											...
											<div class="dataTables_paginate paging_full_numbers"
												...
												<ul class="pagination">
													<li class="paginate_button first">
														<a href="/indexAD/Account?show=0">First</a></li>
													<li class="paginate_button previous"><a
														href="/indexAD/Account?show=${list_product.number-1}">Previous</a></li>
													<li class="paginate_button next">
														<a href="/indexAD/Account?show=${list_product.number+1}">Next</a></li>
													<li class="paginate_button last">
														<a href="/indexAD/Account?show=${list_product.totalPages-1}">Last</a>
													</li>
												</ul>
											</div>
										</div>
						...
						<div class="card card-profile">
				              ...
				              <div class="card-content">
				                <form:form action="/indexAD/Account" modelAttribute="item">
				                
				                <div class="row">
				                    <div class="col-sm-12">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:input path="username" type="text" class="form-control" value="" placeholder="Tài khoản người dùng"/>
				                        <span class="help-block">Ô nhập tài khoản</span>
				                  ...
				                  <div class="row">
				                    <div class="col-sm-12">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:input path="password" type="password" class="form-control" value="" placeholder="Mật khẩu"/>
				                        <span class="help-block">Ô nhập mật khẩu</span>
				                      <span class="material-input"></span></div>
				                    </div>
				                  </div>
				                  <div class="row">
				                    <div class="col-sm-12">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:input path="fullname" type="text" class="form-control" value="" placeholder="Họ tên"/>
				                        <span class="help-block">Ô nhập họ và tên</span>
				                      <span class="material-input"></span></div>
				                    </div>
				                  </div>
				                  <div class="row">
				                    <div class="col-sm-12">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:input path="email" type="email" class="form-control" value="" placeholder="Email"/>
				                        <span class="help-block">Ô nhập địa chỉ Email</span>
				                      <span class="material-input"></span></div>
				                    </div>
				                  </div>
				                  <div class="row">
				                    <div class=" col-sm-6 text-left">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:radiobutton class="custom-control-input" id="inlineRadio2" value="false"  path="admin"/> <span>Người Dùng</span>
				                        <form:radiobutton class="custom-control-input" id="inlineRadio2" value="true"  path="admin"/><span>Quản Trị Viên</span> 
				                        <span class="help-block">Tên loại sẽ giúp bạn phân biệt được các loại sãn phẩm</span>
				                      <span class="material-input"></span></div>
				                    </div>
				                    <div class=" col-sm-6 text-right">
				                      <div class="form-group label-floating is-empty">
				                        <label class="control-label"></label>
				                        <form:radiobutton class="custom-control-input" id="inlineRadio2" value="true"  path="activated"/> <span>Đang Hoạt Động</span>
				                        <form:radiobutton class="custom-control-input" id="inlineRadio2" value="false"  path="activated"/><span>Ngừng Hoạt Động</span> 
				                        <span class="help-block">Tên loại sẽ giúp bạn phân biệt được các loại sãn phẩm</span>
				                      <span class="material-input"></span></div>
				                    </div>
				                  </div>
				                  <div class="row">
				                    <div class="col-md-12 text-center">
				                      <div class="form-group form-button">
				                      	<button formaction="/indexAD/createAccount" class="btn btn-fill btn-info" onclick="demo.showNotification('top','right')">Create<div class="ripple-container"></div></button>
										<button formaction="/indexAD/updateAccount" class="btn btn-fill btn-rose" onclick="demo.showNotification('top','right')">Update<div class="ripple-container"></div></button>
										<a href="/indexAD/Account" class="btn btn-fill btn-rose" onclick="demo.showNotification('top','right')">Reset</a>
				                      </div>
				                    </div>
			                    </div>
			                </form:form>
