    ...
    -->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="/indexAD/OrderDetail"> <i
											...
											<c:forEach var="item" items="${list_product.content}">
												<tr>
								                      ...
								                      <td class="td-actions text-right">
								                        <a class="btn btn-info btn-simple" href="/indexAD/editOrderDetail/${item.id}"><i class="material-icons">person</i></a>
								                        <a class="btn btn-danger btn-simple" href="/indexAD/deleteOrderDetail/${item.id}"><i class="material-icons">close</i></a>
								                      </td>
							                    </tr>
											</c:forEach>
										</table>
											...
											<div class="dataTables_paginate paging_full_numbers"
												...
												<ul class="pagination">
													<li class="paginate_button first">
														<a href="/indexAD/OrderDetail?show=0">First</a></li>
													<li class="paginate_button previous"><a
														href="/indexAD/OrderDetail?show=${list_product.number-1}">Previous</a></li>
													<li class="paginate_button next">
														<a href="/indexAD/OrderDetail?show=${list_product.number+1}">Next</a></li>
													<li class="paginate_button last">
														<a href="/indexAD/OrderDetail?show=${list_product.totalPages-1}">Last</a>
													</li>
												</ul>
											</div>
										</div>
